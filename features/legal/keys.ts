export const legalKeys = {
  ...
  archiveLines: () => ['legal_document_lines', 'archive'] as const,
  archiveProformaLines: () => ['proforma_document_lines', 'archive'] as const,
  itemAliases: () => ['legal_external_item_aliases'] as const,
