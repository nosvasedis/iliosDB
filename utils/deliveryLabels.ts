...
export const DELIVERY_SKU_STONE_STYLES: Record<string, string> = {
  ...
  'AM': 'bg-teal-100 text-teal-800 border-teal-200', 'AZM': 'bg-teal-100 text-teal-800 border-teal-200', 'LR': 'bg-indigo-100 text-indigo-700 border-indigo-200', 'SB': 'bg-sky-100 text-sky-700 border-sky-200', 'MP': 'bg-blue-100 text-blue-600 border-blue-200',
