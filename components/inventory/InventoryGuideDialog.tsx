...
const steps = [
  {
    icon: Search,
    title: '1. Εντοπισμός κύριου SKU',
    body: 'Αναζητήστε με κύριο SKU, πλήρη παραλλαγή, περιγραφή ή μέγεθος. Για γρήγορη και ακριβή εύρεση χρησιμοποιήστε τη Σάρωση.',
  },
  {
    icon: BookOpen,
  ...
  {
    icon: ShieldCheck,
    title: '3. Επιβεβαίωση ταυτότητας αποθέματος',
    body: 'Πριν από μεταβολή, ελέγξτε πλήρες SKU, μέγεθος και αποθήκη. Οι ποσότητες της επιλεγμένης θέσης εμφανίζονται ακριβώς δίπλα στις ενέργειες.',
  },
];
              ...
              <div className="flex gap-3 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    Ορίζει το πραγματικό φυσικό απόθεμα της επιλεγμένης θέσης. Χρησιμοποιείται για απογραφή ή τεκμηριωμένη διόρθωση και απαιτεί αιτιολογία.
                  </p>
                </div>
              </div>
              <div className="flex gap-3 p-4">
          ...
          {isAdmin && (
            <section className="rounded-xl border border-amber-200 bg-amber-50 p-4" aria-labelledby="guide-initial-count-title">
              ...
              <ol className="mt-3 space-y-2 text-sm leading-6 text-amber-900/85">
                <li>1. Σαρώστε ή αναζητήστε το κύριο SKU.</li>
                <li>2. Ανοίξτε την ακριβή παραλλαγή, το μέγεθος και την αποθήκη.</li>
                <li>3. Επιλέξτε «Διόρθωση» και καταχωρίστε τη μετρημένη ποσότητα ως νέο Φυσικό Απόθεμα.</li>
                <li>4. Χρησιμοποιήστε αιτιολογία όπως «Αρχική φυσική απογραφή ΗΗ/ΜΜ/ΕΕΕΕ» και επιβεβαιώστε την καταχώριση.</li>
              </ol>
            </section>
          )}
          {!isAdmin && (
