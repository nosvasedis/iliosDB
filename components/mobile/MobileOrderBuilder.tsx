...
export default function MobileOrderBuilder({ onBack, initialOrder, products, attachSeller = false }: Props) {
    ...
    const { subtotal, discountAmount, netAmount, vatAmount, grandTotal, consignmentSubtotal, consignmentValue } = buildMobileOrderBuilderTotals(items, discountPercent, vatRate);
