...
const FinderBatchStageSelector = ({ 
    ...
    return (
        <div className="mt-2 pt-2 border-t border-slate-200/50">
            ...
            <div className="flex items-center justify-between" ref={selectorRef}>
                ...
                <div className="relative">
                    ...
                    {/* Expanding stage selector - opens upward to avoid container cutoff */}
                    {isOpen && (
                        <div 
                            className="absolute bottom-full right-0 mb-2 bg-white rounded-xl shadow-xl border border-slate-200 p-2 z-[60] min-w-[150px] max-h-[280px] overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-bottom-1 duration-200"
