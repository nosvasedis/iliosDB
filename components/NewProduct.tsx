...
import { Save, Plus, Trash2, Camera, Calculator, Box, Gem, TrendingUp, MapPin } from 'lucide-react';
...
export default function NewProduct({ products, materials, molds = [], setProducts }: Props) {
  ...
  }, [sku, category, gender, weight, plating, recipe, labor, materials, imageUrl, selectedMolds, isSTX, products]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newProduct: Product = {
      ...
      image_url: imageUrl || 'https://picsum.photos/300/300',
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
            <h3 className="text-lg font-semibold mb-4 text-slate-700 border-b pb-2">1. Βασικά Στοιχεία</h3>
              ...
              <div className="md:col-span-2">
                  ...
                  <div className="p-3 border border-slate-300 rounded-md bg-white max-h-32 overflow-y-auto grid grid-cols-2 gap-2">
                      {molds.length > 0 ? molds.map(m => (
                          ...
                          <span className="text-slate-400 text-sm col-span-2 italic">Δεν υπάρχουν διαθέσιμα λάστιχα. Προσθέστε τα πρώτα.</span>
                      )}
                  </div>
              </div>
              
              {/* Dropdowns for Gender & Category */}
              <div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 sticky top-4">
            ...
            <button type="submit" className="w-full mt-6 bg-slate-900 text-white py-3 rounded-lg font-medium hover:bg-slate-800 flex items-center justify-center gap-2">
