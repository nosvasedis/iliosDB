                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2 flex-wrap">
                                <SkuColorizedText sku={batch.sku} suffix={batch.variant_suffix || ''} gender={product.gender} className="text-2xl font-black tracking-tight" masterClassName="text-slate-800" />
