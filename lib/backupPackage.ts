...
const ENTITY_LABELS_EL: Record<string, string> = {
    ...
    consignment_lines: 'Γραμμές Παρακαταθηκών',
    consignment_allocations: 'Κατανομές Παραγωγής Παρακαταθηκών',
    consignment_settlements: 'Δηλώσεις πώλησης Παρακαταθηκών',
    consignment_payments: 'Εισπράξεις Παρακαταθηκών',
    consignment_returns: 'Επιστροφές Παρακαταθηκών',
    consignment_events: 'Ιστορικό Παρακαταθηκών',
    repair_intakes: 'Παραλαβές Επισκευών',
    repair_items: 'Τεμάχια Επισκευών',
    repair_cycles: 'Κύκλοι Επισκευών',
    repair_cost_lines: 'Κόστη Επισκευών',
    repair_charges: 'Χρεώσεις Επισκευών',
    repair_attachments: 'Αρχεία Επισκευών',
    repair_events: 'Ιστορικό Επισκευών',
