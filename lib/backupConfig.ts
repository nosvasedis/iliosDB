...
export const BACKUP_TABLE_REGISTRY: TableRegistryEntry[] = [
    ...
    { table: 'legal_settings',           displayName: 'Legal_Settings',          primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: false },
    { table: 'legal_numbering_sequences',displayName: 'Legal_Numbering',         primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: true  },
    { table: 'legal_sync_runs',          displayName: 'Legal_Sync_Runs',         primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: false },
    { table: 'legal_carriers',           displayName: 'Legal_Carriers',          primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: true  },
    { table: 'legal_documents',          displayName: 'Legal_Documents',         primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: true  },
    { table: 'legal_document_lines',     displayName: 'Legal_Document_Lines',    primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: true  },
    { table: 'legal_payments',           displayName: 'Legal_Payments',          primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: true  },
    { table: 'legal_transmissions',      displayName: 'Legal_Transmissions',     primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: false },
    { table: 'legal_delivery_events',    displayName: 'Legal_Delivery_Events',   primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: false },
    { table: 'legal_audit_log',          displayName: 'Legal_Audit_Log',         primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: false },
    { table: 'proforma_documents',       displayName: 'Proforma_Documents',      primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: true  },
    { table: 'proforma_document_lines',  displayName: 'Proforma_Lines',          primaryKey: 'id',          primaryKeyType: 'uuid',    includeInCsv: true  },
