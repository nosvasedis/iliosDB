...
export const BACKUP_TABLE_REGISTRY: TableRegistryEntry[] = [
    ...
    { table: 'legal_external_item_aliases', displayName: 'Legal_Item_Aliases',     label: 'Αντιστοιχίσεις Κωδικών',       category: 'legal',      primaryKey: 'id',          primaryKeyType: 'uuid',    conflictTarget: 'external_source,normalized_item_code', includeInCsv: true, dependsOn: ['products'] },
