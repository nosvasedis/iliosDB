...
export const MIGRATION_SCHEMAS: Schema = {
    ...
    order_lines: ['order_id', 'line_number', 'line_id', 'sku', 'variant_suffix', 'size_info', 'quantity', 'price_at_order', 'price_override', 'fulfillment_mode', 'warehouse_id', 'cord_color', 'enamel_color', 'notes'],
    ...
    production_batches: ['id', 'order_id', 'sku', 'variant_suffix', 'quantity', 'current_stage', 'priority', 'type', 'workflow_kind', 'consignment_line_id', 'repair_item_id', 'repair_cycle_id', 'created_at', 'updated_at', 'notes'],
    consignments: ['id', 'code', 'customer_id', 'seller_id', 'source_order_id', 'source_warehouse_id', 'status', 'financial_status', 'review_due_at', 'handed_off_at', 'completed_at', 'notes', 'created_at', 'updated_at'],
    consignment_lines: ['id', 'consignment_id', 'order_line_id', 'product_sku', 'variant_suffix', 'size_info', 'quantity', 'sold_quantity', 'returned_quantity', 'pending_quantity', 'locked_unit_cost', 'locked_unit_price', 'price_override_reason', 'created_at', 'updated_at'],
    consignment_allocations: ['id', 'consignment_line_id', 'production_batch_id', 'quantity', 'created_at'],
    consignment_settlements: ['id', 'consignment_line_id', 'quantity', 'unit_price', 'total_amount', 'paid_amount', 'status', 'price_override_reason', 'legal_document_id', 'sold_at', 'reversed_at', 'reversal_reason', 'created_at', 'updated_at'],
    consignment_payments: ['id', 'settlement_id', 'amount', 'payment_method', 'notes', 'paid_at', 'created_at'],
    ...
    repair_attachments: ['id', 'repair_item_id', 'storage_path', 'file_name', 'content_type', 'attachment_type', 'created_at'],
    repair_events: ['id', 'repair_item_id', 'repair_cycle_id', 'event_type', 'payload', 'actor_user_id', 'created_at'],
...
export function validateCanonicalMigration(migration: CanonicalMigration): MigrationValidationReport {
    ...
    const required: Record<string, string[]> = {
        ...
        consignments: ['id', 'code', 'customer_id'],
        consignment_lines: ['id', 'consignment_id', 'product_sku'],
        repair_intakes: ['id', 'code', 'customer_id'],
        repair_items: ['id', 'code', 'intake_id', 'customer_id'],
        legal_documents: ['id'],
    ...
    const references: Array<[string, string, string, string]> = [
        ...
        ['consignments', 'customer_id', 'customers', 'id'],
        ['consignments', 'source_order_id', 'orders', 'id'],
        ['consignment_lines', 'consignment_id', 'consignments', 'id'],
        ['consignment_lines', 'product_sku', 'products', 'sku'],
        ['consignment_allocations', 'consignment_line_id', 'consignment_lines', 'id'],
        ['consignment_settlements', 'consignment_line_id', 'consignment_lines', 'id'],
        ['consignment_payments', 'settlement_id', 'consignment_settlements', 'id'],
        ['consignment_returns', 'consignment_line_id', 'consignment_lines', 'id'],
        ['repair_intakes', 'customer_id', 'customers', 'id'],
        ['repair_items', 'intake_id', 'repair_intakes', 'id'],
        ['repair_items', 'customer_id', 'customers', 'id'],
        ['repair_items', 'product_sku', 'products', 'sku'],
        ['repair_cycles', 'repair_item_id', 'repair_items', 'id'],
        ['repair_cost_lines', 'repair_item_id', 'repair_items', 'id'],
        ['repair_charges', 'repair_item_id', 'repair_items', 'id'],
        ['repair_attachments', 'repair_item_id', 'repair_items', 'id'],
        ['repair_events', 'repair_item_id', 'repair_items', 'id'],
